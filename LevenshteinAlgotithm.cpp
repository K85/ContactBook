#include "LevenshteinAlgotithm.h"
    ...
    size_t LevenshteinAlgotithm::compare_(const std::string& ref_s, const std::string& ref_l) {
    ...
    float LevenshteinAlgotithm::compare(const std::string& ref1, const std::string& ref2)
    {
